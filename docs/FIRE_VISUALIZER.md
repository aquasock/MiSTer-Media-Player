...
many separate bands. Logarithmic intensity drives interpolated flame heights;
procedural upward-moving turbulence and a red/orange/yellow/white palette supply
the flame texture. Frequency increases from left to right.
...
The combined O-scope/FFT/Fire block fits standalone at 1,216 estimated ALMs
