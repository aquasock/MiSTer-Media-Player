...
for top in ['test_media_fire_visualizers','test_media_player_overlay']:
...
silence=render('test_media_fire_visualizers','silence',['+W=720','+H=480','+VW=640','+VH=480','+X=40','+SILENT=1'])
