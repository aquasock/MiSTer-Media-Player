...
p.add_argument('--top',choices=['flac_predict_mac','flac_subframe','flac_stream_decoder'],default='flac_predict_mac')
...
result={'scope':'isolated primitive, virtual I/O; not a whole-core resource/timing result','top':a.top,'source_sha256':hashlib.sha256(source.read_bytes()).hexdigest(),'mac_sha256':hashlib.sha256((root/'rtl/audio/flac/flac_predict_mac.sv').read_bytes()).hexdigest()}
