...
module mpeg2_h262_hardware_cadence_profiler #(
    ...
    input wire [255:0] transport_status,
...
wire [31:0] snapshot_word_40=transport_status[0+:32];
wire [31:0] snapshot_word_41=transport_status[32+:32];
wire [31:0] snapshot_word_42=transport_status[64+:32];
wire [31:0] snapshot_word_43=transport_status[96+:32];
wire [31:0] snapshot_word_44=transport_status[128+:32];
wire [31:0] snapshot_word_45=transport_status[160+:32];
wire [31:0] snapshot_word_46=transport_status[192+:32];
wire [31:0] snapshot_word_47=transport_status[224+:32];
wire [31:0] snapshot_word_48=snapshot_word_00^snapshot_word_01^
...
always @(posedge clk_mpeg2) begin
    if(reset_mpeg2)begin
        ...
        if(decoder_byte_accepted_q || error_flags_q[14])session_active<=1;
