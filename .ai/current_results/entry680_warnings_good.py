...
import re,json
base=Path('/home/vash/mister-builds/entry679'); old=Path('/home/vash/mister-builds/entry664/FPGA/output_files')
...
(base/'results/warning-vs-good.json').write_text(json.dumps(report,indent=2)+'\n')
