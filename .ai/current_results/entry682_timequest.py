...
assert run['source_commit']=='83c138ebd2492e6b81dfcc1f0256cecae2afce79'
env=os.environ.copy()
env['LD_LIBRARY_PATH']='/home/vash/quartus17-compat/extracted/usr/lib/x86_64-linux-gnu'
cmd=['/home/vash/intelFPGA_lite/17.0_T/quartus/bin/quartus_sta','-t',str(base/'entry681_timing.tcl')]
