...
source = 'c124aa516d7280432a63562d5e3f6a9973c32579'
...
new_assignment = b'set_global_assignment -name SEED 19\n'
...
report.update(source_commit=source, previous_qualification_source_commit=old_source,
              ...
              synthesis_configuration_change='Only SEED 18 -> 19 in MediaPlayer.qsf',
              prior_evidence_hashes_reverified=True, terminal_analyzer_reexecuted=True,
              terminal_gate_tests_passed=True, seed=19, hardware_accepted=False)
