...
base=Path('/tmp/entry599-deployment');base.mkdir(exist_ok=True)
expected={'MiSTer':'3841e2cc6eef4bfc9e46a7ffa075aff76b65d5405f81efb1355373292b35846f','MediaPlayer.rbf':'15bc3057a4f16369bc4a3dac01e30f63e5fc563a43b1922214b5b478c17c66c2'}
f=FTP();f.connect('10.10.0.30',21,timeout=20);f.login('root','1');f.voidcmd('TYPE I')
r={'host':'10.10.0.30','prepared':datetime.now(ZoneInfo('America/Phoenix')).isoformat(timespec='seconds'),'source_commit':'f615ce02ba8a96ac198b26c24ff5c4b7cecfd1b4','backups':{},'operations':[],'deployed':False}
